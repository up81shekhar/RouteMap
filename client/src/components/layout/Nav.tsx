...
function ThemeToggle({ className = "" }: { className?: string }) {
  ...
  return (
    <button
      ...
      className={`flex h-9 w-9 items-center justify-center rounded border border-border text-text-muted hover:border-border-strong hover:text-text-primary ${className}`}
    >
      {theme === "dark" ? (
